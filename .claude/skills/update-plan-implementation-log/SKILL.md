---
name: update-specks-implementation-log
description: |
  Update the plan implementation log with a completion summary for recently completed work.
  Prepends a detailed, well-formatted entry to .specks/specks-implementation-log.md.
disable-model-invocation: true
---

## Summary

Update the `.specks/    .md` file with a completion summary for recently completed implementation work.
...
Review the recent conversation context to understand what implementation work was completed, then generate and prepend a completion summary to `.specks/specks-implementation-log.md`.
...
- [ ] Verified the entry was added correctly with `head -60 .specks/specks-implementation-log.md`
