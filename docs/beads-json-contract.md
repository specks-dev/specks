# Beads JSON Contract (Specks)

This document is the **minimal contract** between Specks and the Beads CLI (or a mock `bd` in tests). All parsing of `bd ... --json` output and all fake `bd` implementations MUST conform to this.

**Normative source:** [.specks/specks-1.md §1.0.1.6 Beads JSON Contract](../.specks/specks-1.md#beads-json-contract-normative).

## Commands and output shapes

| Command | Output shape | Fields Specks reads |
|---------|--------------|---------------------|
