...
mod tests {
    ...
    #[test]
    fn test_speck_extract_section_by_anchor() {
...
"#;
        ...
        let strategy = speck.extract_section_by_anchor("strategy").unwrap();
        ...
        let criteria = speck.extract_section_by_anchor("success-criteria").unwrap();
    ...
    #[test]
    fn test_speck_extract_section_by_anchor_missing() {
        ...
        assert!(speck.extract_section_by_anchor("nonexistent").is_none());
    }

    #[test]
    fn test_speck_extract_section_last_in_document() {
        let content = r#"## Phase 1.0: Test {#phase-1}
...
"#;
        ...
        let last = speck.extract_section_by_anchor("last-section").unwrap();
        assert!(last.contains("This is the last section."));
        assert!(last.contains("It goes to the end of the document."));
    }

    #[test]
    fn test_speck_extract_section_with_nested_headings() {
        let content = r#"## Phase 1.0: Test {#phase-1}
...
"#;
        ...
        let section = speck.extract_section_by_anchor("section").unwrap();
    ...
    #[test]
    fn test_speck_render_root_description() {
        let content = r#"## Phase 1.0: Test {#phase-1}
...
"#;
        ...
        let desc = speck.render_root_description();
    ...
    #[test]
    fn test_speck_render_root_design() {
        let mut speck = Speck::default();
