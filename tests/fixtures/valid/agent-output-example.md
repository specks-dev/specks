...
**Purpose:** Demonstrates what a speck looks like after agent execution, including bead IDs and completed checkpoints.
...
This speck demonstrates the output format after agents have processed it.
Key features shown:
- Bead IDs written by `specks beads sync`
