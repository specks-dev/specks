## Phase 1.0: Minimal Valid Speck {#phase-1}

**Purpose:** A minimal valid speck for testing purposes.
...
This is a minimal speck that should pass validation with no errors.
